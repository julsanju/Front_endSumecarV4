...
@Component({
  ...
  templateUrl: './mensajes-pendientes.component.html',
  styleUrls: ['./mensajes-pendientes.component.css']
})
export class MensajesPendientesComponent implements OnInit  {
  dataUser : string = '';
  ...
  ngOnInit() {
    ...
    this.servicio.obtenerFiltrado(data).subscribe(
      (response) => {
